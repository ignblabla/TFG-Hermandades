...
class TestTipoActoListView(unittest.TestCase):
    ...
    def test_flujo_feliz_y_llamadas_correctas_200(self, mock_service, mock_serializer_class):
        ...
        Given: Una petición GET autenticada a la vista de tipos de acto.
        ...
        Then: La vista devuelve un 200 OK con la data correcta, habiendo llamado 
            al servicio y configurado el serializador para múltiples objetos.
        """
        ...
        datos_respuesta = [{"id": 1, "nombre": "Misa"}]
